...
class CoinsFragment(
    ...
    private val adapter = CoinsAdapter(onCoinClick = { coin -> openCoinDetails(coin.symbol) })
    ...
    private fun openCoinDetails(symbol: String) {
        appNavigator.openCoinDetails(findNavController(), symbol)
    }
